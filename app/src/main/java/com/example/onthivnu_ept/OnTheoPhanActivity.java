                    ...
                    case 0: {
                        ...
                        btnNopBai.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                if (questionListenAdapterP1.getPlayer() != null)
                                    questionListenAdapterP1.player.stop();
                                if (questionListenAdapterP1.is_filled()) {
                                    checkAnswers1();
                                    ShowDialogResult();
                                } else
                                    Toast.makeText(context, "Hãy trả lời tất cả các câu hỏi", Toast.LENGTH_LONG).show();
                            }
                        });
